...
import com.blossom.tools.encodes.Encodes;
import com.blossom.tools.properties.PropsUtils;
import com.blossom.tools.string.StringUtils;

/**
 * @Description: 文件操作工具类
 * @author Blossom
 * @time 2016年12月13日 下午10:08:23
 */
public class FileUtils {
	...
	/**
	 * @Description: 移动文件到指定文件夹下
	 * @author Blossom
	 * @time 2016年12月13日 下午10:16:31
	 * @return_type void
	 *
	 */
	...
	/**
	 * @Description: 修改文件的最后访问时间。如果文件不存在就创建该文件
	 * @author Blossom
	 * @throws Exception
	 * @time 2016年12月14日 下午8:03:41
	 * @return_type void
	 *
	 */
	public static boolean touch(File file) throws Exception {
	 ...
	 * @Description: 修改文件的最后访问时间。如果文件不存在就创建该文件
	 * @author Blossom
	 * @time 2016年12月14日 下午8:08:45
	 * @return_type boolean
	 *
	 */
	public static boolean touch(String fileName) throws Exception {
	 ...
	 * @author Blossom
	 * @throws Exception
	 * @time 2016年12月14日 下午8:09:42
	 * @return_type void
	 *
	 */
	public static void touch(File[] files) throws Exception {
	 ...
	 * @author Blossom
	 * @throws Exception
	 * @time 2016年12月14日 下午8:10:56
	 * @return_type void
	 *
	 */
	public static void touch(String[] fileNames) throws Exception {
	...
	/**
	 * @Description: 验证指定的文件是否存在
	 * @author Blossom
	 * @time 2016年12月14日 下午8:12:17
	 * @return_type boolean
	 *
	 */
	...
	/**
	 * @Description: 创建指定的目录；如果指定的目录的父目录不存在则创建目录上所有需要的目录
	 * @author Blossom
	 * @time 2016年12月14日 下午8:14:04
	 * @return_type boolean
	 *
	 */
	public static boolean makeDircetory(File file) {
	...
	/**
	 * @Description: 创建指定的目录；如果指定的目录的父目录不存在则创建目录上所有需要的目录
	 * @time 2016年12月14日 下午8:15:44
	 * @return_type boolean
	 *
	 */
	public static boolean makeDircetory(String fileName) {
		File file = new File(fileName);
		return makeDircetory(file);
	}

	/**
	 * @Description: 情况指定目录中的文件;删除全部文件，只要有一个文件没有被删除就会返回false
	 * @author Blossom
	 * @time 2016年12月14日 下午8:17:54
	 * @return_type boolean
	 *
	 */
	...
	/**
	 * @Description: 清空指定目录中的文件
	 * @author Blossom
	 * @time 2016年12月14日 下午8:21:13
	 * @return_type boolean
	 *
	 */
	public static boolean emptyDirectory(String directoryName) {
		File file = new File(directoryName);
		return emptyDirectory(file);
	}

	/**
	 * @Description: 删除指定目标及其中的所有文件内容
	 * @author Blossom
	 * @time 2016年12月14日 下午8:22:27
	 * @return_type boolean
	 *
	 */
	...
	/**
	 * @Description: 删除目录及其中的所有内容
	 * @author Blossom
	 * @time 2016年12月14日 下午8:26:05
	 * @return_type boolean
	 *
	 */
	...
	/**
	 * @Description: 获取目录中的所有内容，包括其子目录中的内容
	 * @author Blossom
	 * @time 2016年12月14日 下午8:27:19
	 * @return_type File[]
	 *
	 */
	...
	/**
	 * @Description: 将目录中的内容添加到列表
	 * @author Blossom
	 * @time 2016年12月14日 下午8:31:50
	 * @return_type void
	 *
	 */
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public static void list(List list, File file, FileFilter filter) {
	...
	/**
	 * @Description: 从文件名得到文件路径
	 * @author Blossom
	 * @time 2016年12月14日 下午8:35:18
	 * @return_type String
	 *
	 */
	...
	/**
	 * @Description: 得到文件的名字部分
	 * @author Blossom
	 * @time 2016年12月14日 下午8:48:04
	 * @return_type String
	 *
	 */
	...
	/**
	 * @Description: 得到文件名中的父路径部分。
	 * @author Blossom
	 * @time 2016年12月14日 下午8:49:04
	 * @return_type String
	 *
	 */
	...
	/**
	 * @Description: 得到路径分隔符在文件路径中最后出现的位置。
	 * @author Blossom
	 * @time 2016年12月14日 下午8:54:37
	 * @return_type int
	 *
	 */
	...
	/**
	 * @Description: 检查给定目录的存在性
	 * @author Blossom
	 * @time 2016年12月14日 下午9:00:11
	 * @return_type boolean
	 *
	 */
	public static boolean pathValidate(String path) {
		...
		for (int i = 0; i < arrayPath.length; i++) {
			tmpPath += "/" + arrayPath[i];
			File file = new File(tmpPath.substring(1));
			if (!file.exists()) {
				if (!file.mkdir()) {
					return false;
				}
	...
	/**
	 * @Description: 根据文件内容生成文件
	 * @author Blossom
	 * @time 2016年12月14日 下午9:07:20
	 * @return_type boolean
	 *
	 */
	...
	/**
	 * @Description: 获取图片文件的名称
	 * @author Blossom
	 * @time 2016年12月14日 下午9:08:14
	 * @return_type String
	 *
	 */
	...
	public static final int countPics(String id, String dtime, String extensions) {
		...
		FileFilterUtils mfilter = new FileFilterUtils(extensions.split(","));
	 ...
	 */
	/*
	 * public static void writeToFile(String fileName, String content, boolean
	 * append) { try { FileUtils.write(new File(fileName), content, "utf-8",
	 * append); logger.debug("文件 " + fileName + " 写入成功!"); } catch (IOException
	 * e) { logger.debug("文件 " + fileName + " 写入失败! " + e.getMessage()); } }
	 */
	 ...
	 */
	/*
	 * public static void writeToFile(String fileName, String content, String
	 * encoding, boolean append) { try { FileUtils.write(new File(fileName),
	 * content, encoding, append); logger.debug("文件 " + fileName + " 写入成功!"); }
	 * catch (IOException e) { logger.debug("文件 " + fileName + " 写入失败! " +
	 * e.getMessage()); } }
	 */
